...
**Tip: Pre-load 3–4 consultations before demo. Upload the 5th live.**
...
### Scene 1: Show Pre-loaded Consultations (30 sec)

> **[Switch to the app — Dashboard page]**
>
> "Ramesh has been seeing Dr. Ananya Sharma for three years. We've already uploaded four of his consultations into DrDejaVu."
>
> **[Click through the consultation sidebar — show dates spanning Jan 2023 to Nov 2024]**
>
> "Each consultation was recorded as audio. Our system used **Eigen's Higgs ASR V3.0** — which has a 9.12% word error rate — to transcribe every word. Then **gpt-oss-120b** automatically extracted diagnoses, medications, lifestyle advice, and key health metrics into structured summaries."
...
### Scene 4: Ask a Second Question — Text (30 sec)

> **[Type in the chat box]:** *"What medications have I stopped taking?"*
>
> **[Show the response]**
>
> "Instantly, the system pulls from multiple consultations: 'You were originally on Metformin, Lisinopril, and Atorvastatin. Lisinopril was stopped in March 2024 when your blood pressure normalized. Metformin was discontinued in February 2026 after your diabetes entered remission. You currently only take Atorvastatin.'"
>
> "Three years of medication history — recalled in two seconds."

### Scene 5: History Timeline (15 sec)

> **[Navigate to /history]**
>
> "And for a visual overview, the History page shows Ramesh's entire health journey as a timeline — every consultation, every summary, expandable with full transcripts. A longitudinal health record built from voice."
...
- [ ] 4 consultations pre-uploaded (consultations 1–4)
- [ ] Consultation 5 audio file ready on desktop for live upload
...
> "Recordings are passive. You still have to listen to a 30-minute audio to find one answer. DrDejaVu is *active memory* — it indexes, cross-references, and synthesizes across years of visits. Ask a question, get a precise answer in seconds."
